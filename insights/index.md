...
![Telemetry converging through a value lens into dashboard form](../assets/img/insights-hero.png)
...
1. **Is anyone actually using it?** — activation vs licensed; active days; return rate.
2. **Is usage becoming skill?** — readiness and maturity (asking → finding → producing → delegating).
3. **Is the work getting cheaper or faster?** — hours saved and assisted value, grounded in task baselines — not token burn.
...
![Telemetry transforming into rising assisted-value geometry](../assets/img/insights-section.png)
...
**Next:** [Effective Choice](../choice/) · [Effective Measurements](../measurements/) · [Our Goal](../)
